...
Color Tracer::CalculateColor(const Ray& ray, const Hit& hit, const Scene& scene, unsigned int iteration) const
{
    if(hit.dist != INF)
    {
...
void Tracer::RenderImage(JiMP2::BMP& bmp, const Camera& cam, const Scene& scene)
{
